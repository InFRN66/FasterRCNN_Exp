...
def resnet18(pretrained=False, imagenet_weight=False):
...
def resnet34(pretrained=False, imagenet_weight=False):
...
def resnet50(pretrained=False, imagenet_weight=False):
...
def resnet101(pretrained=False, imagenet_weight=False):
...
def resnet152(pretrained=False, imagenet_weight=False):
...
class resnet(_fasterRCNN):
  ...
  def _init_modules(self):
    if self.num_layers == 18:
      resnet = resnet18(self.pretrained, self.imagenet_weight)
    elif self.num_layers == 34:
      resnet = resnet34(self.pretrained, self.imagenet_weight)
    elif self.num_layers == 50:
      resnet = resnet50(self.pretrained, self.imagenet_weight)
    elif self.num_layers == 101:
      resnet = resnet101(self.pretrained, self.imagenet_weight)
    elif self.num_layers == 152:
      resnet = resnet152(self.pretrained, self.imagenet_weight)
    else:
    ...
    self.RCNN_base = nn.Sequential(resnet.conv1, resnet.bn1, resnet.relu,
      resnet.maxpool, resnet.layer1, resnet.layer2, resnet.layer3) # until layer3

    self.RCNN_top = nn.Sequential(resnet.layer4) # layer4
